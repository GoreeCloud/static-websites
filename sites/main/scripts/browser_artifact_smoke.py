...
PAGES = ("/", "/platform-systems/", "/suite/", "/office-suite/", "/firefox/", "/stable/", "/github/", "/contact/")
...
def main() -> int:
    ...
    try:
        ...
        print("Browser smoke passed for all eight canonical pages at desktop, tablet, and mobile viewports.")
        return 0
